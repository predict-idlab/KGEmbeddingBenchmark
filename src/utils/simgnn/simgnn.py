...
from utils.simgnn.layers import AttentionModule, TenorNetworkModule
from utils.simgnn.utils import process_pair, calculate_loss, calculate_normalized_ged
...
class SimGNNTrainer(object):
    ...
    def networkx_to_json(self, g1, g2, ged):
        G1 = networkx.read_gexf('/Users/psbonte/Documents/Github/SimGNN/dataset/gexf/IMDBMulti/'+g1+'.gexf')
        G2 = networkx.read_gexf('/Users/psbonte/Documents/Github/SimGNN/dataset/gexf/IMDBMulti/'+g2+'.gexf')
    ...
    def score(self):
        ...
        for graph_pair in tqdm(self.testing_graphs):
            ...
            data_t = self.transfer_to_torch(data)
            target = data_t["target"]
            prediction = self.model(data_t)
            self.scores.append(calculate_loss(prediction, target))
            print(data['ged'],target,prediction)
